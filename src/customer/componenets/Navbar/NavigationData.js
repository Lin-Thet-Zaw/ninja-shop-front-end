      ...
      sections: [
        {
          ...
          name: 'Clothing',
          items: [
            { name: 'Tops', href: '/filters/tops' },
            { name: 'Dresses', href: '/filters/tops' },
            { name: 'Pants', href: '/filters/tops' },
            { name: 'Denim', href: '/filters/tops' },
            { name: 'Sweaters', href: '/filters/tops' },
            { name: 'T-Shirts', href: '/filters/tops' },
            { name: 'Jackets', href: '/filters/tops' },
            { name: 'Activewear', href: '/filters/tops' },
            { name: 'Browse All', href: '/filters/tops' },
          ],
        },
        {
          id: 'accessories',
          name: 'Accessories',
          items: [
            { name: 'Watches', href: '/filters/tops' },
            { name: 'Wallets', href: '/filters/tops' },
            { name: 'Bags', href: '/filters/tops' },
